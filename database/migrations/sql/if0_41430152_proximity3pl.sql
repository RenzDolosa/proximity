...
CREATE TABLE
  IF NOT EXISTS `user_groups` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `group_number` varchar(64) NOT NULL COMMENT 'Auto-generated unique group number',
    `group_name` varchar(100) NOT NULL COMMENT 'Human-readable name e.g. Administrator',
    `description` varchar(255) DEFAULT NULL,
    `is_enabled` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1 = enabled, 0 = disabled',
    `permissions` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'JSON object: { order: true, social: false, ... }' CHECK (json_valid(`permissions`)),
