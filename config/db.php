...
const PAGE_ICONS = [
  ...
  'delete-remarks'              => 'fa-trash-alt',
  'delete-single-remarks'       => 'fa-trash-alt',
  'export-remarks'              => 'fa-download',
  'delete-attendance'           => 'fa-trash-alt',
  'delete-single-attendance'    => 'fa-trash-alt',
  'export-attendance'           => 'fa-download',
];
...
function scanPortalPages(
  ...
  array $exclude = [
    ...
    'global_audio.php',
    'incident_report.php',
    'notifications_backend.php',
    'face-employees.php',
    'face-identify.php',

    'qr_search_backend.php',
    'scanTest_search_backend.php',
    'facial-identification.php',
    ...
    'tablePanel' => [
      ...
      'children' => [
        ...
        [
          ...
          'children' => [
            ['key' => 'delete-remarks',            'label' => 'Delete',          'icon' => 'fa-trash-alt',       'children' => []],
            ['key' => 'delete-single-remarks',     'label' => 'Delete Single',   'icon' => 'fa-trash-alt',       'children' => []],
            ['key' => 'export-remarks',            'label' => 'Export',          'icon' => 'fa-download',        'children' => []],
          ],
        ],
        [
          'key'      => 'attendance',
          ...
          'children' => [
            ['key' => 'delete-attendance',         'label' => 'Delete',          'icon' => 'fa-trash-alt',       'children' => []],
            ['key' => 'delete-single-attendance',  'label' => 'Delete Single',   'icon' => 'fa-trash-alt',       'children' => []],
            ['key' => 'export-attendance',         'label' => 'Export',          'icon' => 'fa-download',        'children' => []],
          ],
        ],
      ],
    ],
