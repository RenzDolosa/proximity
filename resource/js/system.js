      ...
      onFocus: async () => {
        try {
          const [proxRes, allEmpRes] = await Promise.all([
            ...
            fetch(`${EmployeesBackend}?action=get&page=1&limit=1&filter_options=1`, {
              headers: {
                "X-Requested-With": "XMLHttpRequest",
                "X-Silent-Request": "true",
              },
...
async function loadEmployees(
  ...
  try {
    ...
    // filter dropdowns and add/edit-form autocomplete have data to work with).
    // Plain page turns, sorting, and silent polls skip this to avoid a full
