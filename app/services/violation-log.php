        ...
        <table class="thead-table">
          <thead>
            <tr>
              ...
              <th class=" emp-remark sortable-th" data-col="violation_type">Type <span class="sort-icon">⇅</span></th>
              <th class="sortable-th" data-col="violation_description">Description <span class="sort-icon">⇅</span></th>
              <th class="sortable-th" data-col="violation_date">Creation Date <span class="sort-icon">⇅</span></th>
